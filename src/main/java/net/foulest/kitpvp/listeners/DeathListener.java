...
public class DeathListener implements Listener {
    ...
    public static void handleDeath(Player receiver, boolean onPlayerQuit) {
        ...
        // Removes Feather Falling enchant from the player.
        if (receiverData.isFeatherFallingEnchant()) {
        ...
        // Removes Feather Falling enchant from the player.
        if (receiverData.isThornsEnchant()) {
            MessageUtil.messagePlayer(receiver, "&eYour &cThorns &eenchantment was removed on death.");
            receiverData.setThornsEnchant(false);
        }

        // Removes Protection enchant from the player.
        if (receiverData.isProtectionEnchant()) {
        ...
        // Removes Knockback enchant from the player.
        if (receiverData.isKnockbackEnchant()) {
            MessageUtil.messagePlayer(receiver, "&eYour &cKnockback &eenchantment was removed on death.");
            receiverData.setKnockbackEnchant(false);
        }

        // Removes Sharpness enchant from the player.
        if (receiverData.isSharpnessEnchant()) {
        ...
        // Removes Punch enchant from the player.
        if (receiverData.isPunchEnchant()) {
            MessageUtil.messagePlayer(receiver, "&eYour &cPunch &eenchantment was removed on death.");
            receiverData.setPunchEnchant(false);
        }

        // Removes Power enchant from the player.
        if (receiverData.isPowerEnchant()) {
